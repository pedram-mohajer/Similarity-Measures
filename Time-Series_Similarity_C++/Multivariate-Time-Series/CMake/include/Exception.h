...
class WrongClassifier : public Exception
{
    public :
	WrongClassifier (string _msg,string _fileName=" ",int _line=-1);

};


class WrongMeasureSimilarity : public Exception
{
    public :
	WrongMeasureSimilarity (string _msg,string _fileName=" ",int _line=-1);

};

class WrongNumberOfDataset : public Exception
{
    public :
	WrongNumberOfDataset (string _msg,string _fileName=" ",int _line=-1);
...
{
    public :
	WrongDimension (string _msg,string _fileName=" ",int _line=-1);

};

class wrongInputNumber : public Exception
{
    public :
	wrongInputNumber (string _msg,string _fileName=" ",int _line=-1);
