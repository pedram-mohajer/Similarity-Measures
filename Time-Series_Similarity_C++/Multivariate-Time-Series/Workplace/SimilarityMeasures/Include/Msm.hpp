...
class Msm : public MeasureSimilarity
{
    ...
    double msmCost(vector<vector <string>> &tsA, int nA, vector<vector <string>> &tsB, int nB, vector<vector <string>> & tsC, int nC, int dim, double cost, int idxA, int idxB, int idxC);
