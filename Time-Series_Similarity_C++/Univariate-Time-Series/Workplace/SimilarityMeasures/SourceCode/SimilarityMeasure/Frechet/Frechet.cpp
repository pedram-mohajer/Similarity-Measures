...
double Frechet::point2SegmentDistance(double *ts1, int n1, double *ts2, int n2, int dim, int idx1, int idx2)
{
...
void Frechet::criticValCalculate(double *ts1, int n1, double *ts2, int n2, int dim, double *criticVal, int *criticSize)
{
    int i, j;
...
//-------------------------------------------------------------------------------------------------
void Frechet::circleLineIntersectCalculation(double *ts1, int n1, double *ts2, int n2, int dim, double radius, int idx1, int idx2,
...
//-------------------------------------------------------------------------------------------------
void Frechet::freelineCalculate(double *ts1, int n1, double *ts2, int n2, int dim, double eps, int idx1, int idx2, double *valPt1, double *valPt2)
{
    double px, py;
...
//-------------------------------------------------------------------------------------------------
void Frechet::freespaceCalculate(double *ts1, int n1, double *ts2, int n2, int dim, double eps, double ***LF, double ***BF)
{
...
//-------------------------------------------------------------------------------------------------
bool Frechet::reachableCalculate(double *ts1, int n1, double *ts2, int n2, int dim, double eps)
{
