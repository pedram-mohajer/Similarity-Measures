...
void Cidtw::compute(TimeSeries *Ts1, TimeSeries *Ts2 ,double & _cidtwDist,int &_cidtwLen )
{
    ...
    double *timeSerieDataFirst        =  VectorToDouble(timeSerieDataFirstStr);
    double *timeSerieDataSecond       =  VectorToDouble(timeSerieDataSecondStr);
...
double Cidtw::euclideanCalculate(double *ts1,int n1,double *ts2,int n2,int dim, int idx1,int idx2)
{
    double euclDist = 0;
    int i;
    double tmp;
