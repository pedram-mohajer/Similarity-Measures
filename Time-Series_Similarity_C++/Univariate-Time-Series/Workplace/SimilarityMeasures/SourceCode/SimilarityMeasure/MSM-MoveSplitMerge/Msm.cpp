...
//-------------------------------------------------------------------------------------------------
double Msm::msmCost(double *tsA, int nA, double *tsB, int nB, double *tsC, int nC, int dim, double cost, int idxA, int idxB, int idxC)
{
...
double Msm::euclideanCalculate(double *ts1,int n1,double *ts2,int n2,int dim, int idx1,int idx2)
{
    double euclDist = 0;
    int i;
    double tmp;
