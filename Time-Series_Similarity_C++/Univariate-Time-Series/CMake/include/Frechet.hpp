...
class Frechet : public MeasureSimilarity
{
    ...
    void criticValCalculate(vector <double>ts1, int n1, vector <double>ts2, int n2, int dim, vector<double>criticVal, int *criticSize);
    
    void circleLineIntersectCalculation(vector <double>ts1, int n1, vector <double>ts2, int n2, int dim, double radius, int idx1, int idx2,
                                        double * matrix[] , int _column);

    void freelineCalculate(vector <double>ts1, int n1,vector <double>ts2, int n2, int dim, double eps, int idx1, int idx2, double *valPt1, double *valPt2);

    void freespaceCalculate(vector <double>ts1, int n1, vector <double>ts2, int n2, int dim, double eps, double ***LF, double ***BF);
    
    bool reachableCalculate(vector <double>ts1, int n1,vector <double>ts2, int n2, int dim, double eps);
